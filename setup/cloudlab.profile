...
#TBURL = "https://github.com/leeymcj/rdma/raw/master/setup.tar.gz"
TBURL = "https://github.com/juncgu/cloudlab-rdma-setup/blob/master/setup.tar.gz"
...
#
pc.defineParameter("node_type", "Hardware spec of nodes to use",
                   portal.ParameterType.NODETYPE, "c6220", legalValues=["r320", "c6220", "d430", "d6515"], longDescription="Refer the hardware", advanced=False, groupId=None)
...
tourDescription = \
  "Apt-get lxc " + '\n' + \
  " 1. x86_64 w/ Ubuntu 14.04 (use this one)" + '\n' + \
  " 2. x86_64 w/ Centos 7.1 (no pmem kernel)" + '\n' + \
  " 3. ARM64 w/ Ubuntu 16.04 (nvml or xio will not compile)" + '\n' + '\n' + \
  "nbdx + lxc + ramdisk" + '\n' 

tourInstructions = \
  "/usr/loca/src has scripts" + '\n' + \
  "Graph App : precise lxc-container" + '\n' + \
  "ramdisk=1G, /boot/grub/grub.cfg" + '\n'
...
#x86_ubuntu_disk_image = 'urn:publicid:IDN+apt.emulab.net+image+rsc-PG0:Apt-lxc.node-2'
x86_ubuntu_disk_image = 'urn:publicid:IDN+apt.emulab.net+image+gaia-PG0:u14-04-ib'
#x86_ubuntu_disk_image = 'urn:publicid:IDN+utah.cloudlab.us+image+emulab-ops//UBUNTU14-64-STD'
#x86_ubuntu_disk_image = 'urn:publicid:IDN+apt.emulab.net+image+rsc-PG0:Apt-lxc'
...
for cpname in computeNodeNames:
    ...
    cpnode.node_type = params.node_type
